...
PROMPTS = {
    ...
    "docs_generate_issues": (
        ...
        "   - The title in the EXACT following JSON format (this is mandatory and non-negotiable):\n"
        "     {{Type: 'Folder'/'File', Path: ['Folder/File's Path'], Readme File Name: ['Readme File Name']}}\n"
        "     Example for a folder: {{Type: 'Folder', Path: ['src/components'], Readme File Name: ['README.md']}}\n"
        "     Example for a file: {{Type: 'File', Path: ['src/components/Button.tsx'], Readme File Name: ['README.md']}}\n"
        ...
        "IMPORTANT: The title MUST be in the exact JSON format shown above. Any other format will be rejected.\n"
    ),
    ...
    "docs_decompose_feature": (
        ...
        "Current main task: {current_issue}\n"
        "A repository has already been checked out for you. Examine the existing code and then think through, "
        "step by step, which task sections are needed to fully document this section.\n"
        "For each task section, you MUST provide:\n"
        "1. A title in the EXACT following JSON format (this is mandatory and non-negotiable):\n"
        "   {{Type: 'Folder'/'File', Path: ['Folder/File's Path'], Readme File Name: ['Readme File Name'], Section Name: ['Section Name']}}\n"
        "   Example for a folder: {{Type: 'Folder', Path: ['src/components'], Readme File Name: ['README.md'], Section Name: ['Getting Started']}}\n"
        "   Example for a file: {{Type: 'File', Path: ['src/components/Button.tsx'], Readme File Name: ['README.md'], Section Name: ['API Reference']}}\n"
        "2. A description; \n"
        ...
        "IMPORTANT: The section title MUST be in the exact JSON format shown above. Any other format will be rejected.\n"
        "IMPORTANT: Make sure each section is distinct and doesn't overlap with other sections.\n"
        "IMPORTANT: Use the generate_tasks tool to generate the tasks for each section.\n"
    ),
    "docs_validate_subtasks": (
        "Review the following documentation sections to ensure they meet these criteria:\n"
        "1. Title Requirements:\n"
        "   - Title must be in the following format: {{Type: 'Folder'/'File', Path: ['Folder/File's Path'], Readme File Name: ['Readme File Name'], Section Name: ['Section Name']}};\n"
